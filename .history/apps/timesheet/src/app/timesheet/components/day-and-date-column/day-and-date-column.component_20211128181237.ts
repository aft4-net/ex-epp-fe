import { Component, Input, OnInit, Output, EventEmitter, OnChanges, AfterViewInit, QueryList, ViewChildren } from '@angular/core';
...
export class DayAndDateColumnComponent implements OnInit, OnChanges,AfterViewInit {
  ...
  overflow = false;
  moreEntries: any[] = [];
  constructor(private timesheetService: TimesheetService,public elRef:Elementr) {
  }
