    ...
    this.entriesDiv?.changes.subscribe(() => {
      ...
      this.entriesDiv.toArray().forEach(el => {
        this.entriesDiv?.toArray().map(i=>{
          if(this.entriesDiv.toArray()[this.overflowPt].nativeElement.getBoundingClientRect().bottom< this.pointerEl.nativeElement.getBoundingClientRect().top){
            this.overflowPt=this.index!;
            console.log(this.overflowPt)
            console.log(this.entriesDiv.toArray()[this.overflowPt])
                       } console.log(i,i.nativeElement.getBoundingClientRect().bottom);console.log(this.pointerEl.nativeElement.getBoundingClientRect().top)
        });        
