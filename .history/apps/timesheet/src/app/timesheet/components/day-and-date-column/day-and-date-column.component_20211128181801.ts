import { Component, Input, OnInit, Output, EventEmitter, OnChanges, AfterViewInit, QueryList, ViewChildren, ElementRef, Directive } from '@angular/core';
...
export class DayAndDateColumnComponent implements OnInit, OnChanges,AfterViewInit {
  ...
  for (let entry in this.entries)
    this.entries.nativeElement.parent
  }
  let enRef:HTMLElement=this.elRef.nativeElement;
  }
