  ...
  ngOnChanges(): void {
    ...
    this.entriesDiv?.changes.subscribe(() => {
      ...
      this.entriesDiv.toArray().forEach(el => {
        this.entriesDiv?.toArray().map(i=>{
          if(i.nativeElement.getBoundingClientRect().bottom< this.pointerEl.nativeElement.getBoundingClientRect().top){
            this.overflowPt=this.index!;
            console.log(this.overflowPt)
          } console.log(i.nativeElement.getBoundingClientRect().bottom);
        });        
     
      this.index!++;
       }    
               
      ); console.log(this.overflowPt)console.log(this.pointerEl.nativeElement.getBoundingClientRect().top)console.log(this.pointerEl.nativeElement.getBoundingClientRect().top)
