  ...
  ngOnChanges(): void {
    ...
    this.entriesDiv?.changes.subscribe(() => {
      ...
      this.entriesDiv.toArray().forEach(el => {
        this.entriesDiv?.toArray().map(i=>{if(i.nativeElement.getBoundingClientRect().bottom< this.pointerEl.nativeElement.getBoundingClientRect().top){});
          if(el.nativeElement.getBoundingClientRect.bottom
