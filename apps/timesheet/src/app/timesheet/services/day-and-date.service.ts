...
export class DayAndDateService {
  ...
  myFunction10(cuur1: any, increamt: any): any[] {
    return this.myFunctionWeek1(cuur1, increamt);
  }

  myFunction11(cuur1: any, decreament: any): any[] {
  ...
  myFunctionWeek0(cuur1: any, decrease: any): any[] {
    if (cuur1 != null) {
      this.weekDays = [];
      this.lastday = '';
      this.firstday = '';
  ...
  myFunctionWeek1(cuur1: any, inc: any): any[] {
