...
//     providedIn: 'any'
// })
// export class PersonalDetailDataStateService
...
//     public readonly nationalities$ = of(convertStringsToSelectOptions(dummyNationalitiesData))
//     public readonly employeeIdNumberPrefices$ = of(convertStringsToSelectOptions(dummyEmployeeIdNumberPrefices))
//     public readonly genders$ = of(convertStringsToSelectOptions(dummyGendersData))

//     public readonly defaultEmployeeIdNumberPrefix$ = of(convertStringToSelectOption(dummyDefaultEmployeeIdNumberPrefix))
