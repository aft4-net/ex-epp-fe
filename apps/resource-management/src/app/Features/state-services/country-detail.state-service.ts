...
export class CountryDetailStateService
    ...
    >
{
    ...
    // Test Data
    public readonly defaultEmployeeIdNumberPrefices = 'EDC/DT'
    public readonly countriesName$ = of(['Ethiopia', 'India', 'United States'])
    public readonly nationalities$ = of(['American', 'Ethiopian', 'Indian'])
    public readonly employeeIdNumberPrefices$ = of(['EDC/DT', 'EDC/QA', 'EDC/HR', 'EDC/FD', 'EDC/LT'])
